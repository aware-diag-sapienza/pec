"""
K-means clustering -- from: scikit-learn 0.23.2 --
Modified to have callbacks at each iteration of the algorithm.
...
def _kmeans_single_elkan(X, sample_weight, n_clusters, max_iter=300,
                         ...
                         __fn__on_iteration_start=None, __fn__on_iteration_end=None):
    ...
    __fn__on_iteration_start : function(iteration, timestamp), default=None
        Callback function called at the beginning of each iteration.

    __fn__on_iteration_end : function(iteration, timestamp, labels, is_last), default=None
    ...
    for i in range(max_iter):
        __pending_last_iteration = None
        #<>#
        if __fn__on_iteration_start is not None:
            if i== 0: __fn__on_iteration_start(i, __start__timestamp)
            else: __fn__on_iteration_start(i, time.time())
        #</>#
        ...
        if np.array_equal(labels, labels_old):
            ...
            #<>#
            if __fn__on_iteration_end is not None:
                __fn__on_iteration_end(i, labels.copy(), True)
            #</>#
            break
        else:
            ...
            #<>#
            if __fn__on_iteration_end is not None:
                __fn__on_iteration_end(i, labels.copy(), False)
            #</>#
    ...
    if not strict_convergence:
        #<>#
        if __fn__on_iteration_start is not None:
            __fn__on_iteration_start(i+1, time.time())
        #</>#
        ...
        #<>#
        if __fn__on_iteration_end is not None:
            __fn__on_iteration_end(i+1, labels.copy(), True)
        #</>#
...
class KMeans(TransformerMixin, ClusterMixin, BaseEstimator):
    ...
    def fit(self, X, y=None, sample_weight=None, on_partial_result=None):
        ...
        on_partial_result : function(partial_result), default=None
            Callback function called at the end of each iteration.
        ...
        """
        #####
        __iterations_start_timestamps = {}
        def __fn__on_iteration_start(iteration, timestamp): #internal function to be called from iteration
            __iterations_start_timestamps[iteration] = timestamp
        
        def __fn__on_iteration_end(iteration, labels, is_last): #internal function to be called from iteration
            duration = time.time() - __iterations_start_timestamps[iteration]
            r = Bunch(
                iteration = iteration,
                duration = duration,
                labels = labels,
        ...
        for seed in seeds:
            ...
            labels, inertia, centers, n_iter_ = kmeans_single(
                ...
                __fn__on_iteration_start=__fn__on_iteration_start,
                __fn__on_iteration_end=__fn__on_iteration_end)
    ...
    def fit_predict(self, X, y=None, sample_weight=None, on_partial_result=None):
        ...
        """
        return self.fit(X, sample_weight=sample_weight, on_partial_result=on_partial_result).labels_
